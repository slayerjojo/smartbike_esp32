...
static const mpu_i2caddr_t MPU_DEFAULT_I2CADDRESS = MPU_I2CADDRESS_AD0_LOW;
...
static const mpu_bus_t& MPU_DEFAULT_BUS                = hspi;
static const mpu_addr_handle_t MPU_DEFAULT_ADDR_HANDLE = nullptr;
#endif
...
static const mot_stat_t MOT_STAT_XNEG       = (1 << MPUR_MOT_STATUS_X_NEG_BIT);
static const mot_stat_t MOT_STAT_XPOS       = (1 << MPUR_MOT_STATUS_X_POS_BIT);
static const mot_stat_t MOT_STAT_YNEG       = (1 << MPUR_MOT_STATUS_Y_NEG_BIT);
static const mot_stat_t MOT_STAT_YPOS       = (1 << MPUR_MOT_STATUS_Y_POS_BIT);
static const mot_stat_t MOT_STAT_ZNEG       = (1 << MPUR_MOT_STATUS_Z_NEG_BIT);
static const mot_stat_t MOT_STAT_ZPOS       = (1 << MPUR_MOT_STATUS_Z_POS_BIT);
static const mot_stat_t MOT_STAT_ZEROMOTION = (1 << MPUR_MOT_STATUS_ZRMOT_BIT);
#endif

/*! Standby Mode */
typedef uint8_t stby_en_t;
static const stby_en_t STBY_EN_NONE    = (0x0);
static const stby_en_t STBY_EN_ACCEL_X = (1 << MPUR_PWR2_STBY_XA_BIT);
static const stby_en_t STBY_EN_ACCEL_Y = (1 << MPUR_PWR2_STBY_YA_BIT);
static const stby_en_t STBY_EN_ACCEL_Z = (1 << MPUR_PWR2_STBY_ZA_BIT);
static const stby_en_t STBY_EN_ACCEL   = (STBY_EN_ACCEL_X | STBY_EN_ACCEL_Y | STBY_EN_ACCEL_Z);
static const stby_en_t STBY_EN_GYRO_X  = (1 << MPUR_PWR2_STBY_XG_BIT);
static const stby_en_t STBY_EN_GYRO_Y  = (1 << MPUR_PWR2_STBY_YG_BIT);
static const stby_en_t STBY_EN_GYRO_Z  = (1 << MPUR_PWR2_STBY_ZG_BIT);
static const stby_en_t STBY_EN_GYRO    = (STBY_EN_GYRO_X | STBY_EN_GYRO_Y | STBY_EN_GYRO_Z);
static const stby_en_t STBY_EN_TEMP    = (1 << 6);
...
static const stby_en_t STBY_EN_LOWPWR_GYRO_PLL_ON = (1 << 7);
...
static const auxi2c_stat_t AUXI2C_STAT_FSYNC     = (1 << MPUR_I2CMST_STAT_PASS_THROUGH_BIT);
static const auxi2c_stat_t AUXI2C_STAT_LOST_ARB  = (1 << MPUR_I2CMST_STAT_LOST_ARB_BIT);
static const auxi2c_stat_t AUXI2C_STAT_SLV4_DONE = (1 << MPUR_I2CMST_STAT_SLV4_DONE_BIT);
static const auxi2c_stat_t AUXI2C_STAT_SLV4_NACK = (1 << MPUR_I2CMST_STAT_SLV4_NACK_BIT);
static const auxi2c_stat_t AUXI2C_STAT_SLV3_NACK = (1 << MPUR_I2CMST_STAT_SLV3_NACK_BIT);
static const auxi2c_stat_t AUXI2C_STAT_SLV2_NACK = (1 << MPUR_I2CMST_STAT_SLV2_NACK_BIT);
static const auxi2c_stat_t AUXI2C_STAT_SLV1_NACK = (1 << MPUR_I2CMST_STAT_SLV1_NACK_BIT);
static const auxi2c_stat_t AUXI2C_STAT_SLV0_NACK = (1 << MPUR_I2CMST_STAT_SLV0_NACK_BIT);
...
static const int_en_t INT_EN_NONE          = (0x0);
static const int_en_t INT_EN_MOTION_DETECT = (1 << MPUR_INT_ENABLE_MOTION_BIT);
static const int_en_t INT_EN_FIFO_OVERFLOW = (1 << MPUR_INT_ENABLE_FIFO_OFLOW_BIT);
static const int_en_t INT_EN_I2C_MST_FSYNC = (1 << MPUR_INT_ENABLE_I2C_MST_FSYNC_BIT);  // int from I2C_MST_STATUS
static const int_en_t INT_EN_PLL_READY     = (1 << MPUR_INT_ENABLE_PLL_RDY_BIT);
static const int_en_t INT_EN_DMP_READY     = (1 << MPUR_INT_ENABLE_DMP_RDY_BIT);
static const int_en_t INT_EN_RAWDATA_READY = (1 << MPUR_INT_ENABLE_RAW_DATA_RDY_BIT);
#if defined CONFIG_MPU6000 || defined CONFIG_MPU6050 || defined CONFIG_MPU9150
static const int_en_t INT_EN_FREE_FALL   = (1 << MPUR_INT_ENABLE_FREEFALL_BIT);
static const int_en_t INT_EN_ZERO_MOTION = (1 << MPUR_INT_ENABLE_ZEROMOT_BIT);
#endif
...
static const int_stat_t INT_STAT_MOTION_DETECT = (1 << MPUR_INT_STATUS_MOTION_BIT);
static const int_stat_t INT_STAT_FIFO_OVERFLOW = (1 << MPUR_INT_STATUS_FIFO_OFLOW_BIT);
static const int_stat_t INT_STAT_I2C_MST_FSYNC = (1 << MPUR_INT_STATUS_I2C_MST_BIT);  // int from I2C_MST_STATUS
static const int_stat_t INT_STAT_PLL_READY     = (1 << MPUR_INT_STATUS_PLL_RDY_BIT);
static const int_stat_t INT_STAT_DMP_READY     = (1 << MPUR_INT_STATUS_DMP_RDY_BIT);
static const int_stat_t INT_STAT_RAWDATA_READY = (1 << MPUR_INT_STATUS_RAW_DATA_RDY_BIT);
#if defined CONFIG_MPU6000 || defined CONFIG_MPU6050 || defined CONFIG_MPU9150
static const int_stat_t INT_STAT_FREE_FALL   = (1 << MPUR_INT_STATUS_FREEFALL_BIT);
static const int_stat_t INT_STAT_ZERO_MOTION = (1 << MPUR_INT_STATUS_ZEROMOT_BIT);
#endif
...
static const fifo_config_t FIFO_CFG_GYRO =
    (1 << MPUR_FIFO_XGYRO_EN_BIT | 1 << MPUR_FIFO_YGYRO_EN_BIT | 1 << MPUR_FIFO_ZGYRO_EN_BIT);
static const fifo_config_t FIFO_CFG_ACCEL       = (1 << MPUR_FIFO_ACCEL_EN_BIT);
static const fifo_config_t FIFO_CFG_TEMPERATURE = (1 << MPUR_FIFO_TEMP_EN_BIT);
static const fifo_config_t FIFO_CFG_SLAVE0      = (1 << MPUR_FIFO_SLV_0_EN_BIT);
static const fifo_config_t FIFO_CFG_SLAVE1      = (1 << MPUR_FIFO_SLV_1_EN_BIT);
static const fifo_config_t FIFO_CFG_SLAVE2      = (1 << MPUR_FIFO_SLV_2_EN_BIT);
static const fifo_config_t FIFO_CFG_SLAVE3      = (1 << 8);
#if defined CONFIG_MPU_AK89xx
static const fifo_config_t FIFO_CFG_COMPASS = (FIFO_CFG_SLAVE0);  // 8 bytes
#endif
...
static const dmp_features_t DMP_FEATURE_TAP =            {0x001};
static const dmp_features_t DMP_FEATURE_ANDROID_ORIENT = {0x002};
static const dmp_features_t DMP_FEATURE_LP_QUAT =        {0x004};
static const dmp_features_t DMP_FEATURE_PEDOMETER =      {0x008};
static const dmp_features_t DMP_FEATURE_6X_LP_QUAT =     {0x010};
static const dmp_features_t DMP_FEATURE_GYRO_CAL =       {0x020};
static const dmp_features_t DMP_FEATURE_SEND_RAW_ACCEL = {0x040};
static const dmp_features_t DMP_FEATURE_SEND_RAW_GYRO =  {0x080};
static const dmp_features_t DMP_FEATURE_SEND_CAL_GYRO =  {0x100};

// DMP Tap axes
typedef uint8_t dmp_tap_axis_t;
static const dmp_tap_axis_t DMP_TAP_X       {0x30};
static const dmp_tap_axis_t DMP_TAP_Y       {0x0C};
...
static const mag_stat1_t MAG_STAT1_DATA_RDY = {1 << MPUR_STATUS1_DATA_RDY_BIT};
#ifdef CONFIG_MPU_AK8963
static const mag_stat1_t MAG_STAT1_DATA_OVERRUN = {1 << MPUR_STATUS1_DATA_OVERRUN_BIT};
#endif

/*! Magnetometer sensor status 2 */
typedef uint8_t mag_stat2_t;
static const mag_stat2_t MAG_STAT2_SENSOR_OVERFLOW = {1 << MPUR_STATUS2_OVERFLOW_BIT};
#ifdef CONFIG_MPU_AK8963
static const mag_stat2_t MAG_STAT2_BIT_OUTPUT_SETTING = {1 << MPUR_STATUS2_BIT_OUTPUT_M_BIT};
#elif CONFIG_MPU_AK8975
static const mag_stat2_t MAG_STAT2_DATA_ERROR{1 << MPUR_STATUS2_DATA_ERROR_BIT};
#endif
...
static const selftest_t SELF_TEST_PASS{0x0};
static const selftest_t SELF_TEST_GYRO_FAIL{1 << 0};   // 0x1
static const selftest_t SELF_TEST_ACCEL_FAIL{1 << 1};  // 0x2
